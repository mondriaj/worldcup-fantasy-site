...
async function writeBrowserWrappers({ authority, score, projections, recommendations }) {
  ...
  await writeFile("fantasyPoolScorePredictionsData.js", [
    ...
    "// Active Final Round score prediction browser data plus SF/QF/R16/R32 history.",
  ...
  await writeFile("fantasyPoolMatchdayProjectionsData.js", [
    ...
    "// Active Final Round projection browser data plus SF/QF/R16/R32 history.",
  ...
  await writeFile("fantasyPoolRecommendationsData.js", [
    ...
    "// Active Final Round recommendations plus SF/QF/R16/R32 history rows.",
