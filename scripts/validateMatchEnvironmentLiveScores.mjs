...
const [html, scriptText, r32ScorePredictionData, r16ScorePredictionData, liveMatchdayData, liveFixtureQa] = await Promise.all([
...
const scoreRows = [...r32ScoreRows, ...r16ScoreRows];
