...
Generated: 2026-07-18T17:28:44.967Z
...
| manifest_validation | commandCheck | yes | pass | 30 | node scripts/validateActiveStageManifestV1.mjs |
| final_round_browser_content_contract | commandCheck | yes | pass | 34 | node scripts/validateFinalRoundBrowserContentContractV1.mjs |
| team_builder_browser_equivalence | commandCheck | yes | pass | 615 | node scripts/validateFinalRoundBuilderBrowserEquivalenceV1.mjs |
| team_builder_golden_final_round | commandCheck | yes | pass | 35 | node scripts/validateTeamBuilderGoldenFinalRoundV1.mjs |
| eligible_players | commandCheck | yes | pass | 130 | node scripts/validateFinalRoundEligiblePlayersV1.mjs |
| fixture_exposure_strategy | commandCheck | yes | pass | 28 | node scripts/validateFinalRoundFixtureExposureStrategyV1.mjs |
...
| active_fantasy_data_flow | commandCheck | yes | pass | 164 | node scripts/validateActiveFantasyDataFlow.mjs |
...
| world_cup_fixtures_page_live_scores | commandCheck | yes | pass | 29 | node scripts/validateWorldCupFixturesPageLiveScores.mjs |
...
| public_payload_contract | commandCheck | yes | pass | 289 | node scripts/validatePublicPayloadContractV1.mjs |
| public_preview_browser_qa | commandCheck | yes | pass | 8935 | node scripts/runPublicPreviewBrowserQa.mjs |
| git_diff_whitespace | commandCheck | yes | pass | 51 | git diff --check |
...
| syntax:knockoutBracketPredictionData.js | syntaxCheck | yes | pass | 16 | node --check knockoutBracketPredictionData.js |
| syntax:fantasyPoolRecommendationsData.js | syntaxCheck | yes | pass | 30 | node --check fantasyPoolRecommendationsData.js |
| syntax:fantasyPoolMatchdayProjectionsData.js | syntaxCheck | yes | pass | 45 | node --check fantasyPoolMatchdayProjectionsData.js |
