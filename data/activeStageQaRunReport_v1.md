...
Generated: 2026-07-19T11:58:33.785Z
...
| manifest_validation | commandCheck | yes | pass | 42 | node scripts/validateActiveStageManifestV1.mjs |
...
| team_builder_browser_equivalence | commandCheck | yes | pass | 656 | node scripts/validateFinalRoundBuilderBrowserEquivalenceV1.mjs |
| team_builder_golden_final_round | commandCheck | yes | pass | 32 | node scripts/validateTeamBuilderGoldenFinalRoundV1.mjs |
...
| team_builder_eligibility_helpers | commandCheck | yes | pass | 99 | node scripts/validateTeamBuilderEligibilityHelpersV1.mjs |
...
| eligible_players | commandCheck | yes | pass | 131 | node scripts/validateFinalRoundEligiblePlayersV1.mjs |
| fixture_exposure_strategy | commandCheck | yes | pass | 32 | node scripts/validateFinalRoundFixtureExposureStrategyV1.mjs |
| team_builder_final_round | commandCheck | yes | pass | 33 | node scripts/validateTeamBuilderFinalRoundV1.mjs |
| core_pick_lineup_evidence | commandCheck | yes | pass | 23 | node scripts/validateFinalRoundCorePickLineupEvidence.mjs |
| active_fantasy_data_flow | commandCheck | yes | pass | 171 | node scripts/validateActiveFantasyDataFlow.mjs |
...
| public_payload_contract | commandCheck | yes | pass | 296 | node scripts/validatePublicPayloadContractV1.mjs |
| public_preview_browser_qa | commandCheck | yes | pass | 9080 | node scripts/runPublicPreviewBrowserQa.mjs |
| git_diff_whitespace | commandCheck | yes | pass | 19 | git diff --check |
| syntax:script.js | syntaxCheck | yes | pass | 20 | node --check script.js |
...
| syntax:fantasyPoolRecommendationsData.js | syntaxCheck | yes | pass | 27 | node --check fantasyPoolRecommendationsData.js |
...
| syntax:scripts/validateTeamBuilderGoldenFinalRoundV1.mjs | syntaxCheck | yes | pass | 28 | node --check scripts/validateTeamBuilderGoldenFinalRoundV1.mjs |
| syntax:scripts/validateTeamBuilderSharedModelHelpersV1.mjs | syntaxCheck | yes | pass | 18 | node --check scripts/validateTeamBuilderSharedModelHelpersV1.mjs |
| syntax:scripts/validateTeamBuilderRulesHelpersV1.mjs | syntaxCheck | yes | pass | 18 | node --check scripts/validateTeamBuilderRulesHelpersV1.mjs |
| syntax:scripts/validateTeamBuilderEligibilityHelpersV1.mjs | syntaxCheck | yes | pass | 19 | node --check scripts/validateTeamBuilderEligibilityHelpersV1.mjs |
...
### team_builder_optimizer_utilities

Status: pass

No output.

### team_builder_constraint_helpers

Status: pass

No output.

### team_builder_artifact_browser_unification_readiness
...
### syntax:scripts/validateTeamBuilderRulesHelpersV1.mjs
...
### syntax:scripts/validateTeamBuilderOptimizerUtilitiesV1.mjs

Status: pass

No output.

### syntax:scripts/validateTeamBuilderConstraintHelpersV1.mjs

Status: pass

No output.

### syntax:scripts/validateTeamBuilderArtifactBrowserUnificationReadinessV1.mjs
