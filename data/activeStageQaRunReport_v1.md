...
Generated: 2026-07-18T16:42:56.850Z
...
| manifest_validation | commandCheck | yes | pass | 34 | node scripts/validateActiveStageManifestV1.mjs |
| final_round_browser_content_contract | commandCheck | yes | pass | 50 | node scripts/validateFinalRoundBrowserContentContractV1.mjs |
| team_builder_browser_equivalence | commandCheck | yes | pass | 692 | node scripts/validateFinalRoundBuilderBrowserEquivalenceV1.mjs |
| team_builder_golden_final_round | commandCheck | yes | pass | 40 | node scripts/validateTeamBuilderGoldenFinalRoundV1.mjs |
| eligible_players | commandCheck | yes | pass | 136 | node scripts/validateFinalRoundEligiblePlayersV1.mjs |
...
| active_fantasy_data_flow | commandCheck | yes | pass | 196 | node scripts/validateActiveFantasyDataFlow.mjs |
| live_fixture_mapping | commandCheck | yes | pass | 51 | node scripts/validateLiveFixtureMapping.mjs |
| match_environment_live_scores | commandCheck | yes | pass | 36 | node scripts/validateMatchEnvironmentLiveScores.mjs |
...
| bracket_path_integrity | commandCheck | yes | pass | 35 | node scripts/validateBracketPathIntegrityV1.mjs |
| knockout_bracket_prediction | commandCheck | yes | pass | 36 | node scripts/validateKnockoutBracketPredictionV1.mjs |
| public_payload_contract | commandCheck | yes | pass | 307 | node scripts/validatePublicPayloadContractV1.mjs |
| public_preview_browser_qa | commandCheck | yes | pass | 9094 | node scripts/runPublicPreviewBrowserQa.mjs |
| git_diff_whitespace | commandCheck | yes | pass | 56 | git diff --check |
...
| syntax:fantasyPoolRecommendationsData.js | syntaxCheck | yes | pass | 29 | node --check fantasyPoolRecommendationsData.js |
...
| syntax:fantasyPoolOfficialDataStatusData.js | syntaxCheck | yes | pass | 36 | node --check fantasyPoolOfficialDataStatusData.js |
| syntax:liveMatchdayStatusData.js | syntaxCheck | yes | pass | 26 | node --check liveMatchdayStatusData.js |
...
| syntax:scripts/lib/teamBuilderPublicModel.mjs | syntaxCheck | yes | pass | 19 | node --check scripts/lib/teamBuilderPublicModel.mjs |
...
| syntax:scripts/validateFinalRoundBrowserContentContractV1.mjs | syntaxCheck | yes | pass | 18 | node --check scripts/validateFinalRoundBrowserContentContractV1.mjs |
