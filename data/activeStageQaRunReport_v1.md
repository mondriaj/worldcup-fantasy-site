...
Generated: 2026-07-18T15:53:00.696Z
...
| manifest_validation | commandCheck | yes | pass | 36 | node scripts/validateActiveStageManifestV1.mjs |
| team_builder_browser_equivalence | commandCheck | yes | pass | 697 | node scripts/validateFinalRoundBuilderBrowserEquivalenceV1.mjs |
| eligible_players | commandCheck | yes | pass | 144 | node scripts/validateFinalRoundEligiblePlayersV1.mjs |
...
| core_pick_lineup_evidence | commandCheck | yes | pass | 24 | node scripts/validateFinalRoundCorePickLineupEvidence.mjs |
...
| bracket_path_integrity | commandCheck | yes | pass | 57 | node scripts/validateBracketPathIntegrityV1.mjs |
| knockout_bracket_prediction | commandCheck | yes | pass | 40 | node scripts/validateKnockoutBracketPredictionV1.mjs |
| public_payload_contract | commandCheck | yes | pass | 306 | node scripts/validatePublicPayloadContractV1.mjs |
| public_preview_browser_qa | commandCheck | yes | pass | 8375 | node scripts/runPublicPreviewBrowserQa.mjs |
| git_diff_whitespace | commandCheck | yes | pass | 76 | git diff --check |
| syntax:script.js | syntaxCheck | yes | pass | 24 | node --check script.js |
...
| syntax:fantasyPoolOfficialDataStatusData.js | syntaxCheck | yes | pass | 32 | node --check fantasyPoolOfficialDataStatusData.js |
