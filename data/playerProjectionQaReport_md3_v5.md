...
| Check | Result |
| --- | --- |
| MD3 rows resolve to active official players | true |
| Recommendation candidates have projections | true |
| No unavailable positive actionable projection | true |
| No NaN/Infinity | true |
| Floor/ceiling valid | true |
| Captain upside score valid | true |
...
| --- | --- | --- | ---: | ---: | --- |
| Luis Suárez | Luis Suárez | playing | 3.979 | 0.58 | not_in_public_md3_recommendations_after_caution |
| Nico O'Reilly | Nico O'Reilly | playing | 5.714 | 0.672 | not_in_public_md3_recommendations_after_caution |
| Raphinha / Raphael Dias Belloli | Raphael Dias Belloli | playing | 4.735 | 0.162 | not_in_public_md3_recommendations_after_caution |
| German defender injury/status issue | none | n/a | n/a | n/a | no_current_german_defender_injury_or_not_selectable_status_found_in_official_feed |
