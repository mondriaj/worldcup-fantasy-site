...
- Final Round Team Builder constraint helper validator
...
- Constraint helper drift: the Team Builder constraint helper validator freezes pure squad-size, duplicate-player, budget, position, team, fixture, eligibility, lock/exclusion, captain/vice, and starter/bench validation before deeper optimizer extraction.
