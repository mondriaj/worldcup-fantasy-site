...
- `officialSquadsImportReport_v0.json` - generated import-pipeline report for final official squads; currently waiting for an official squad input file.
- `officialSquadsImportPipeline_v0.md` - plain-language model note for the final official squad reconciliation pipeline.
- `imports/officialSquads_TEMPLATE.csv` - required-column template for the future final official squad import.
