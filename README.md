...
- Saved Decision Export v0 stores only the latest manual quick-check result after the user runs it. It does not restore those saved decisions on import yet.
